...
╔═══════════════════════════════════════════════════╗
║   class AntonioSoria {                            ║
║     val role    = "Matemático & Programador"      ║
║     val passion = "algorithms & AI"               ║
║     val uni     = "UNAM · UAM Iztapalapa"         ║
║     fun solve(problem): Solution {                ║
║       return BFS(problem) ?: A_star(problem)      ║
║     }                                             ║
║   }                                               ║
╚═══════════════════════════════════════════════════╝
```
...
*"Visualizo un día en el que volaremos sobre un mundo en el que los seres humanos sean libres de la monotonía y vivan la vida como debería vivirse."*
*— Claude Shannon*
